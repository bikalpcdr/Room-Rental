 ...
 * @returns {Promise}
 */
export const createUser = (username: string, email: string, password: string, fullName: string, phoneNumber: string, role: string) =>
 ...
 * @returns {Promise}
 */
export const updateUser = (id: string, username: string, fullName: string, phoneNumber: string, role: string) =>
 ...
 * @returns {Promise}
 */
export const deleteUserById = (userId: string) => apiClient.delete(`/users/${userId}`);
 ...
 * @returns {Promise}
 */
export const uploadPropertyImages = (propertyId: string, images: File[] = []) => {
    const formData = new FormData();
...
export const createPropertyWithImages = (propertyData: any, images: File[] = []) => {
    const formData = new FormData();
 ...
 * @returns {Promise}
 */
export const updateProperty = (data: any) => apiClient.put('/property', data);
 ...
 * @returns {Promise}
 */
export const deleteProperty = (id: string) => apiClient.delete(`/property/${id}`);
 ...
 * @returns {Promise}
 */
export const getPropertyById = (propertyId: string) => apiClient.get(`/property/${propertyId}`);
 ...
 * @returns {Promise}
 */
export const searchProperties = (filterRequest: any) => apiClient.post('/property/search-property', filterRequest);
 ...
 * @returns {Promise}
 */
export const getBookingsByRenterId = (renterId: string) => apiClient.get(`/booking/renter/${renterId}`);
 ...
 * @returns {Promise}
 */
export const getBookingById = (bookingId: string) => apiClient.get(`/booking/${bookingId}`);
 ...
 * @returns {Promise}
 */
export const createBooking = (bookingData: any) => apiClient.post('/booking', bookingData);
 ...
 * @returns {Promise}
 */
export const updateBooking = (bookingData: any) => apiClient.put('/booking', bookingData);
 ...
 * @returns {Promise}
 */
export const deleteBooking = (bookingId: string) => apiClient.delete(`/booking/${bookingId}`);
 ...
 * @returns {Promise}
 */
export const cancelBooking = (bookingId: string) => apiClient.put(`/booking/cancel/${bookingId}`);
 ...
 * @returns {Promise}
 */
export const approveBooking = (bookingId: string) => apiClient.put(`/booking/approve/${bookingId}`);
 ...
 * @returns {Promise}
 */
export const rejectBooking = (bookingId: string) => apiClient.put(`/booking/reject/${bookingId}`);
 ...
 * @returns {Promise}
 */
export const deletePropertyImage = (imageId: string | number) =>
 ...
 * @returns {Promise}
 */
export const initiateEsewaPayment = ({amount, referenceId, productId, successUrl, failureUrl}: any) =>
 ...
 * @returns {Promise}
 */
export const verifyEsewaPayment = ({amt, rid, pid}: any) =>
 ...
 * @returns {Promise}
 */
export const esewaInquiry = (requestId: string) =>
 ...
 * @returns {Promise}
 */
export const esewaTokenPayment = ({request_id, amount, transaction_code, package_id}: any) =>
 ...
 * @returns {Promise}
 */
export const esewaStatusCheck = ({request_id, amount, transaction_code}: any) =>
...
export const verifyOtp = (emailOrUsername: string, otp: string) => {
...
export const resetPassword = ({emailOrUsername, newPassword, confirmPassword}: any) => {
...
export const changePassword = ({emailOrUsername, currentPassword, newPassword, confirmPassword}: any) => {
 ...
 * @returns {Promise}
 */
export const approvePendingRegistration = (userId: string | number) =>
 ...
 * @returns {Promise}
 */
export const rejectPendingRegistration = (userId: string | number) =>
