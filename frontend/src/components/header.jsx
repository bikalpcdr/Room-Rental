...
function Header() {
  ...
  const updateUserProfilePictureUrl = (newUrl) => {
    const userData = getUserData();
  ...
  const handleUpload = async () => {
    ...
    try {
      ...
      updateUserProfilePictureUrl(newUrl); // Use centralized helper
      toast.success("Profile picture updated!");
      setSelectedImage(null);
      setPreviewUrl(null);
      window.location.reload(); // To update avatar everywhere
    } catch (err) {
          ...
          <div className="mobile-menu" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="mobile-menu-links">
              ...
              {!isAuthenticated() ? (
                ...
                <>
                  <Link to={getDashboardLink()} className="mobile-link" onClick={toggleMenu}>🏠 Dashboard</Link>
