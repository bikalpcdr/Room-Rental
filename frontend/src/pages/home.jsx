              ...
              <div className="col-12 col-lg-9 hero-content">
                ...
                <div className="hero-buttons d-flex flex-wrap gap-3">
                  {!isAuthenticated() ? (
                    <>
                      {/* first register  */}
                      <button onClick={() => openAuthModal('register')} className="btn btn-warning btn-lg fw-bold px-4 py-2 ">
                        Get Start
                      </button>

                      <button onClick={() => openAuthModal('login')} className="btn bg-warning-outline-light btn-lg px-4 py-2 ">
                        Sign In
                      </button>
                    </>
                  ) : (
                    <div className="welcome-message text-white">
                      ...
                      <Link
                        to={userData?.role?.toLowerCase() === 'admin' ? '/admin-dashboard' : `/${userData?.role?.toLowerCase()}-dashboard`}
